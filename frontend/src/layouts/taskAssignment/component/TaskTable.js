...
export default function TaskTable(props) {
  ...
  const columns = [
    ...
    //   { field: "Priority", headerName: "Priority", width: 150 },
      ...
      { field: "start_date", headerName: "Start Date", width: 160, valueFormatter: params => moment(params?.value).format("MM/DD/YYYY"), },
      { field: "end_date", headerName: "End Date", width: 160, valueFormatter: params => moment(params?.value).format("MM/DD/YYYY"), },
...
//   console.log(temp.id);
  return (
    <div style={{ height: 400, width: "100%" }}>
        ...
        {isInformationModalOpen ? <InformationModal isOpen={isInformationModalOpen} toggle={toggleInformationModal} id={taskId}/> : <></>}
      <DataGrid
        rows={newArray}
